  ...
  const recentEvents = [
    {
      ...
      location: 'Comedor Universitario',
      eventObjective: 'Semana internacional de descubrimiento con actividades culturales y académicas.',
    ...
    },
    {
      ...
      location: 'Auditorio Central',
      eventObjective: 'Congreso enfocado en las últimas tendencias tecnológicas.',
    ...
    },
    {
      ...
      location: 'Auditorio principal',
      eventObjective: 'Encuentro para conectar egresados con estudiantes actuales.',
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">¡Bienvenido de nuevo! Aquí tienes un resumen de tus eventos.</p>
      </div>
