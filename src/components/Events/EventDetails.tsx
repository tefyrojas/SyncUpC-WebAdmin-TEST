          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="font-semibold" style={{ color: '#B9FF50' }}>{event.confirmed}</span>
              </div>
              <div className="flex items-center justify-between">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                  event.requiresRegistration ? 'bg-gray-100' : 'bg-gray-100 text-gray-700'
                }`}>
                  style={event.requiresRegistration ? { backgroundColor: '#B9FF5020', color: '#B9FF50' } : {}}
                >
              ...
              <div className="flex items-center justify-between">
                ...
                <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                  event.isPublic ? 'bg-gray-100' : 'bg-gray-100 text-gray-700'
                }`}>
                  style={event.isPublic ? { backgroundColor: '#B9FF5020', color: '#B9FF50' } : {}}
                >
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-6">
              ...
              <div className="flex flex-wrap gap-2">
                {event.tags.map((tag: string, index: number) => (
                  <span
                    key={index}
                    className="px-3 py-1 rounded-full text-sm" style={{ backgroundColor: '#B9FF5020', color: '#B9FF50' }}
                  >
                    {tag}
                  </span>
                ))}
